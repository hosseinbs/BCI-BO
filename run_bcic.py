...
#         elif os.uname()[1] == 'tatanka.local' or os.uname()[1] == 'bison.local': 
#             myPython_path = 'python'
#         else:
#             myPython_path = 'python'
# 
#             print 'set python path!!!!!!'
# #            sys.exit()
#     elif os.name == 'nt':
...
#     bcic = Main.Main('BCI_Framework', dataset_name, classifier, feature, channels, number_of_CSPs, myPython_path)
    ...
    if train_or_test == 'run':
        print "run"
        bcic = Main.Main('BCI_Framework', dataset_name, classifier, feature, channels= channels, number_of_CSPs = number_of_CSPs)
