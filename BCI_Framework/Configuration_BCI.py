...
#         else:
#             
#             print('Error in Configuration_BCI')
#             import sys
#             sys.exit()
        
        
#         if channels != 'ALL' and not channels.isdigit():
#             self.configuration['results_path_str'] = self.configuration['results_path_str'] + '_' + channels
#             start_ind = self.configuration['results_opt_path_str'].find(dataset_name) + len(dataset_name)
#             remaining_parts = self.configuration['results_opt_path_str'][start_ind:]
#             self.configuration['results_opt_path_str'] = self.configuration['results_opt_path_str'][0:start_ind] + '_' + channels + remaining_parts
...
#     def set_numberof_channels(self, n_csps):
#         if n_csps == -1:
#             pass
#         else:
#             self.configuration['number_of_channels'] = len(list(itertools.combinations(range(self.configuration['number_of_classes']),2))) * n_csps            
#             
