    ...
    def train_learner_cv(self, Xs, Y, optimal = False):
        ...
        for i in range(self.config.configuration["number_of_cvs_dict"][self.learner_name]):
            ...
            for param_ind in range(len(scores)):
                ...
                cv = StratifiedKFold(y = Y, n_folds = self.config.configuration["number_of_cv_folds"], random_state = i)
...
#                    print("TRAIN:", train_index, "TEST:", test_index)
                    ...
                    X_train, y_train, X_test, y_test = self.scale_all_data(X_train, y_train, X_test, y_test)
